...
const vec3 IsaacShade0 = vec3(0.890, 0.776, 0.773);
const vec3 IsaacShade1 = vec3(0.812, 0.612, 0.608);
const vec3 IsaacShade2 = vec3(0.725, 0.451, 0.443);

const vec3 PercyShade0 = vec3(1.000, 0.937, 0.549);
