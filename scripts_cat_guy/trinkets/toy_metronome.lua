...
function toyMetronome.Tick(tempoManager)
    ...
    or (CatGuy.Config:Get("MomsHeadphonesHaveMetronome") and CatGuy.PlayerUtils.AnyPlayer(function(player) return player:HasCollectible(CatGuy.CollectibleType.MOMS_HEADPHONES) end))) then
