...
---@field bpmIndices? table<integer, integer> autogenerated
---
---@field offset? integer offset of music playback in milliseconds. Defaults to 0 ms.
---@field intro? integer length of intro in milliseconds. Only necessary if BPM/Time Signature change in the looping section.
---@field length? integer length of looping section in milliseconds. Only necessary if BPM/Time Signature change in the looping section.
---
...
---@field triplet? boolean true if whole song is in triplet time. Affects fire delay.
---@field triplets? table<integer, boolean> beat indices of when song becomes triplet time. 
---@field tripletsIndices? table<integer, integer> autogenerated 
...
local tempoDefs = {
    ...
    [Music.MUSIC_VOID_BOSS]                     = {bpm = 180, intro = 0, length = 106667, triplets = {[0] = false, [288] = true}},
    [Music.MUSIC_DOWNPOUR]                      = {bpm = 144},
    [Music.MUSIC_MINES]                         = {bpm = 136},
    [Music.MUSIC_MAUSOLEUM]                     = {bpm = 119},
    [Music.MUSIC_CORPSE]                        = {bpm = 110, offset = 23},
